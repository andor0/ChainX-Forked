...
extern crate arml_support as arsupport;
#[cfg(test)]
extern crate arml_system as arsystem;
...
use arsupport::storage::linked_node::{LinkedNodeCollection, Node, NodeIndex, NodeT};
...
struct LinkedNodes<T: Trait>(runtime_support::rstd::marker::PhantomData<T>);
